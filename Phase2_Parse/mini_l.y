...
declaration: identifiers COLON array_of INTEGER         {printf("declaration -> identifiers COLON array_of INTEGER\n");}
           ...
           | identifiers error '\n'
           | identifiers error COMMA
           | identifiers error SEMICOLON
           ;
...
var: IDENT var_exp                                      {printf("var -> IDENT (%s)\n", $1);}
   ;
var_exp: /* EMPTY */
       | L_PAREN expression R_PAREN                     {printf("var -> L_PAREN expression R_PAREN\n");}
       ;
