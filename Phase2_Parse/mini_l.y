...
identifiers: identifiers COMMA IDENT                    {printf("identifiers -> identifiers COMMA IDENT\n");}
             ...
             ;
array_of: /* EMPTY */                                   {printf("array_of -> ~e\n");}
